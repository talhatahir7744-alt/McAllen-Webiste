...
export const POST_ES: BlogPost = {
  ...
  featured: { ...IMG.sleeper, alt: 'Mujer durmiendo cómodamente en un colchón de buen soporte que alivia dolores y puntos de presión' },
  excerpt: 'Despertar con dolores y molestias no debería ser parte de tu rutina diaria.',
  sections: [
    {
      paragraphs: [
    ...
    {
      heading: 'Cómo Afecta a Tu Cuerpo la Superficie Donde Duermes',
      paragraphs: [
    ...
    {
      heading: 'Cómo Reconocer las Señales de que Tu Colchón No Está Funcionando',
      paragraphs: [
        ...
        'Fíjate bien en dónde sientes la molestia. El dolor en la parte baja de la espalda suele indicar problemas de soporte para la columna, mientras que el dolor en caderas y hombros normalmente apunta a [problemas con los puntos de presión](/es/blog/pressure-mapping-for-sleep). Si te despiertas seguido durante la noche o sientes que no descansaste de verdad aunque pasaste suficiente tiempo en la cama, puede que tu colchón esté trabajando en contra de lo que tu cuerpo necesita en lugar de apoyarlo.',
      ],
      image: { ...IMG.station, alt: 'Prueba de mapeo de presión en Snooze que muestra dónde un colchón no le da soporte al cuerpo', caption: 'Una prueba rápida de mapeo de presión te muestra exactamente en qué te está fallando tu colchón actual.' },
    },
    {
      heading: 'Conoce las Diferentes Tecnologías de Confort',
      paragraphs: [
    ...
    {
      heading: 'Crea Tu Ambiente Ideal para Dormir',
      paragraphs: [
  ...
  faqs: [
    {
      question: '¿Cuánto tiempo toma normalmente acostumbrarse a un colchón nuevo?',
